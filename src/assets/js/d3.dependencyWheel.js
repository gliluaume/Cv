 ...
 *   .datum({
 *      items: [the name of the packages in the matrix],
...
*/
                    if((items[d.index].colorHue == null) || (isNaN(items[d.index].colorHue))){
                        retColor = "hsl(" + parseInt(((items[d.index].label[0].charCodeAt() - 97) / 26) * 360, 10) + ",90%,70%)";
                    } else {
                        retColor =  "hsl(" + items[d.index].colorHue + ",90%,70%)";
                    }
               // }
                return retColor;
            };
            ...
            g.append("svg:text")
                ...
                .text(function(d) {
                    if (isNullOrWhitespace(items[d.index].label)){
                        return "(empty)";
                    } else {
                        return items[d.index].label; 
                    }
                });
    ...
    var isNullOrWhitespace = function(input) {
        ...
        if (typeof input === 'undefined' || input == null){
            ...
            ret = (input.replace(/\s/g, '').length < 1);
        }
        return ret;
    }
